...
const suiteData = [
  {
    ...
    size: "37 Feet Size",
    description:
      "We specialize in delivering innovative and reliable hospitality experiences. From concept to completion, we collaborate to create exceptional residential and resort accommodations.",
    price: "$259",
  },
  {
    id: 2,
...
const SuiteSection = () => {
  return (
    <section className="suite-area position-relative z-1">
          ...
          <div className="col-xl-12">
            <div className="suite-slide-wrapper position-relative z-2">
              <Swiper
                ...
                navigation={{
                  prevEl: ".suite-area .slider-prev",
                  nextEl: ".suite-area .slider-next",
                }}
              >
                {suiteData.map((suite) => (
                        ...
                        <div className="col-xl-6">
                          <div className="suite-wrapper">
                            <div className="suite-wrap">
                              ...
                              {/* Title */}
                              <h4 className="title text-reveal-anim">
                                {suite.title}
                              </h4>
