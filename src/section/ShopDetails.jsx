        ...
        <div className="col-lg-6 col-xl-6 product-info">
          ...
          <div className="product-details__buttons">
            <div className="product-details__buttons-1">
              <Link to="/shop-cart" className="theme-btn-nine animation-box">
                <span className="royle-btn__text">Add to Cart</span>
            ...
            <div className="product-details__buttons-2">
              <Link to="/shop-product-details" className="theme-btn-nine animation-box">
                <span className="royle-btn__text">Add to Wishlist</span>
                <span className="royle-btn__hover royle-btn__hover--1"></span>
                <span className="royle-btn__hover royle-btn__hover--2"></span>
                <span className="royle-btn__hover royle-btn__hover--3"></span>
                <span className="royle-btn__hover royle-btn__hover--4"></span>
            ...
            <div className="customer-comment">
              ...
              <div className="comment-box">
                ...
                <form id="contact_form" action="/" method="get">
                  ...
                  <div className="mb-3">
                    <input name="Fbotcheck" className="form-control" type="hidden" />
                    <button type="submit" name='Sform' className="theme-btn btn-style-one" data-loading-text="Please wait..."><span className="btn-text">Submit Comment</span></button>
                  </div>
                </form>
              </div> 
            </div>
